...
mongoose.connect('mongodb+srv://admin:admin@cluster0.4mswl.mongodb.net/tung?retryWrites=true&w=majority', {useNewUrlParser: true, useUnifiedTopology: true}, function(err){
    if (err){
...
app.get("/phones", controllerUser.quannam);
